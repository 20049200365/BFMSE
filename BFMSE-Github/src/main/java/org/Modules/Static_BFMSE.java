...
public class Static_BFMSE {
    ...
    public Static_BFMSE(int segmentCount, int segmentLength, int fingerprint_length) {
        ...
        System.out.println("(segmentCount + ARITY - 1): "+(segmentCount + ARITY - 1));
    }
    ...
    private void addAll(int[] keys, ArrayList<Integer>[] values, int Max_set_num){
        ...
        System.out.println("Fingerprint bit length: "+ bit_0);
        System.out.println("Set information length: "+ (total_bit-bit_0));
        System.out.println("Total Bit length of MSMM: "+ total_bit);
    }
